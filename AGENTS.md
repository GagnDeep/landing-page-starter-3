...
grep -ri "lorem ipsum" app components content lib || true
grep -rn "TODO\|FIXME" app components content lib || true
grep -rn "@ts-ignore\|@ts-expect-error\|eslint-disable" app components content lib || true
