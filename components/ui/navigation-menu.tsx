  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "origin-top-center relative mt-1.5 h-(--radix-navigation-menu-viewport-height) w-full overflow-hidden rounded-2xl bg-popover text-popover-foreground shadow-2xl ring-1 ring-foreground/5 duration-100 data-closed:animate-out data-closed:zoom-out-90 data-open:animate-in data-open:zoom-in-90 md:w-(--radix-navigation-menu-viewport-width)",
          className
        )}
        {...props}
      />
